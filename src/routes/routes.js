...
import ApplyUser from "../pages/candidateDashboard/ApplyUser";
import Message from "../pages/candidateDashboard/Message";
const routes = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      {
        path: "/dashboard/applyUser/:email",
        element:<ApplyUser></ApplyUser>
      },
      {
        path: "message",
